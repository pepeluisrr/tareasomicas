...
project = u'Filogenia Cryptosporidium'
copyright = u'2014, José Luis Ruiz Rodríguez'
...
html_theme_options = {
    ...
    'navbar_links': [
    	 ...
    	 ("Base datos NCBI", "http://www.ncbi.nlm.nih.gov/nuccore", True),
     ],
...
html_title = 'Tarea 1 2014'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Biomedicina'

# (Optional) Logo. Should be small enough to fit the navbar (ideally 24x24).
# Path should be relative to the ``_static`` files directory.
html_logo = "Captura10.PNG"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "Captura8.ico"
